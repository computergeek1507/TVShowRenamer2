...
namespace XBMCRPC.Methods
{
   public partial class System
   {
         ...
         public string EjectOpticalDrive()
        {
            ...
            var jRet =  _client.GetData<string>("System.EjectOpticalDrive", jArgs);
            return jRet;
        }

         public XBMCRPC.System.Property.Value GetProperties(XBMCRPC.System.Property.Name[] properties=null)
        {
            var jArgs = new JObject();
             if (properties != null)
             {
            ...
            var jRet =  _client.GetData<XBMCRPC.System.Property.Value>("System.GetProperties", jArgs);
            return jRet;
        }
        ...
        {
            var jArgs = new JObject();
            var jRet =  _client.GetData<string>("System.Hibernate", jArgs);
            return jRet;
        }
        ...
        {
            var jArgs = new JObject();
            var jRet =  _client.GetData<string>("System.Reboot", jArgs);
            return jRet;
        }
        ...
        {
            var jArgs = new JObject();
            var jRet =  _client.GetData<string>("System.Shutdown", jArgs);
            return jRet;
        }
        ...
        {
            var jArgs = new JObject();
            var jRet =  _client.GetData<string>("System.Suspend", jArgs);
            return jRet;
        }
