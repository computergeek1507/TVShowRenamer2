...
namespace XBMCRPC.Methods
{
   ...
   public enum typeEnum
   {
       ...
       public typeEnum type {get;set;}
         ...
         public JObject Introspect(bool getdescriptions=false, bool getmetadata=false, bool filterbytransport=false, filterType filter=null)
        {
         ...
         public JObject NotifyAll(string sender=null, string message=null)
        {
            var jArgs = new JObject();
             if (sender != null)
             {
            ...
            var jRet =  _client.GetData<JObject>("JSONRPC.NotifyAll", jArgs);
            return jRet;
        }
   public class PermissionResponse
   {
       ...
       public bool writefile {get;set;}
         ...
         public PermissionResponse Permission()
        {
            var jArgs = new JObject();
            var jRet =  _client.GetData<PermissionResponse>("JSONRPC.Permission", jArgs);
            return jRet;
        }
        ...
        {
            var jArgs = new JObject();
            var jRet =  _client.GetData<string>("JSONRPC.Ping", jArgs);
            return jRet;
        }
   public class VersionResponse
   {
       ...
       public int patch {get;set;}
        ...
        {
            var jArgs = new JObject();
            var jRet =  _client.GetData<VersionResponse>("JSONRPC.Version", jArgs);
            return jRet;
        }
   }
}
