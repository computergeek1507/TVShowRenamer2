...
namespace XBMCRPC.Methods
{
   public partial class Addons
   {
         ...
         public string ExecuteAddon(string addonid=null, bool wait=false)
        {
            ...
            var jRet = _client.GetData<string>("Addons.ExecuteAddon", jArgs);
            return jRet;
        }

         public string ExecuteAddon2(string addonid=null, string[] params_arg=null, bool wait=false)
        {
            var jArgs = new JObject();
             if (addonid != null)
             {
   ...
   public class GetAddonDetailsResponse
   {
       ...
       public XBMCRPC.List.LimitsReturned limits {get;set;}
         ...
         public GetAddonDetailsResponse GetAddonDetails(string addonid=null, XBMCRPC.Addon.Fields properties=null)
        {
            var jArgs = new JObject();
             if (addonid != null)
             {
            ...
            var jRet =  _client.GetData<GetAddonDetailsResponse>("Addons.GetAddonDetails", jArgs);
            return jRet;
        }
   public class GetAddonsResponse
   {
       ...
       public XBMCRPC.List.LimitsReturned limits {get;set;}
         ...
         public GetAddonsResponse GetAddons(XBMCRPC.Addon.Types type=0, XBMCRPC.Addon.Content content=0, XBMCRPC.Addon.Fields properties=null, XBMCRPC.List.Limits limits=null)
        {
         ...
         public GetAddonsResponse GetAddons2(XBMCRPC.Addon.Types type=0, XBMCRPC.Addon.Content content=0, bool enabled=false, XBMCRPC.Addon.Fields properties=null, XBMCRPC.List.Limits limits=null)
        {
            var jArgs = new JObject();
             if (type != null)
             {
   ...
   public enum GetAddonsenabled
   {
       all,
         ...
         public GetAddonsResponse GetAddons2(XBMCRPC.Addon.Types type=0, XBMCRPC.Addon.Content content=0, GetAddonsenabled enabled=0, XBMCRPC.Addon.Fields properties=null, XBMCRPC.List.Limits limits=null)
        {
            var jArgs = new JObject();
             if (type != null)
             {
