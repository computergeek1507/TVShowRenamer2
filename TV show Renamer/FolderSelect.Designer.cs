namespace TV_Show_Renamer
{
	partial class FolderSelect
	{
		...
		private void InitializeComponent()
		{
			...
			this.buttonSelect.Location = new System.Drawing.Point(12, 65);
			...
			this.buttonCreate.Location = new System.Drawing.Point(106, 65);
			this.buttonCreate.Name = "buttonCreate";
			this.buttonCreate.Size = new System.Drawing.Size(92, 23);
			this.buttonCreate.TabIndex = 2;
			this.buttonCreate.Text = "Create Folder...";
			...
			this.label1.Text = "Please Select or Create a Folder for:";
			// 
			// label2
			// 
