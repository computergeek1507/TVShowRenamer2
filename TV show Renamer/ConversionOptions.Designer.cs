namespace TV_Show_Renamer
{
	partial class ConversionOptions
	{
		...
		private void InitializeComponent()
		{
			...
			this.comboBox2.Location = new System.Drawing.Point(144, 21);
			...
			this.comboBox3.Location = new System.Drawing.Point(255, 21);
			...
			this.comboBox4.Location = new System.Drawing.Point(108, 21);
			...
			this.comboBox5.Location = new System.Drawing.Point(220, 21);
			...
			this.comboBox7.Location = new System.Drawing.Point(365, 21);
			...
			this.checkBox2.Location = new System.Drawing.Point(154, 10);
			this.checkBox2.Name = "checkBox2";
			this.checkBox2.Size = new System.Drawing.Size(85, 17);
			this.checkBox2.TabIndex = 9;
			this.checkBox2.Text = "Remove \"_\"";
			...
			this.checkBox4.Location = new System.Drawing.Point(154, 56);
			...
			this.checkBox5.Location = new System.Drawing.Point(154, 79);
			...
			this.checkBox6.Location = new System.Drawing.Point(154, 102);
			...
			this.label3.Text = "Season Offset:";
			// 
			// numericUpDown2
			// 
			this.numericUpDown2.Location = new System.Drawing.Point(93, 100);
			...
			this.checkBox7.Location = new System.Drawing.Point(6, 96);
			...
			this.comboBox8.Location = new System.Drawing.Point(6, 46);
			...
			this.checkBox8.Location = new System.Drawing.Point(6, 73);
			...
			// groupBoxTitle
			// 
			this.groupBoxTitle.Controls.Add(this.comboBox6);
			this.groupBoxTitle.Controls.Add(this.checkBox8);
			this.groupBoxTitle.Controls.Add(this.checkBox7);
			this.groupBoxTitle.Controls.Add(this.comboBox8);
			this.groupBoxTitle.Location = new System.Drawing.Point(312, 76);
			this.groupBoxTitle.Name = "groupBoxTitle";
			this.groupBoxTitle.Size = new System.Drawing.Size(151, 130);
			this.groupBoxTitle.TabIndex = 25;
			this.groupBoxTitle.TabStop = false;
			this.groupBoxTitle.Text = "Title Options";
			// 
			// groupBoxOther
			// 
			this.groupBoxOther.Controls.Add(this.label1);
			this.groupBoxOther.Controls.Add(this.comboBox9);
			this.groupBoxOther.Controls.Add(this.checkBox2);
			this.groupBoxOther.Controls.Add(this.checkBox3);
			this.groupBoxOther.Controls.Add(this.label2);
			this.groupBoxOther.Controls.Add(this.checkBox4);
			this.groupBoxOther.Controls.Add(this.label3);
			this.groupBoxOther.Controls.Add(this.numericUpDown2);
			this.groupBoxOther.Controls.Add(this.checkBox5);
			this.groupBoxOther.Controls.Add(this.numericUpDown1);
			this.groupBoxOther.Controls.Add(this.checkBox6);
			this.groupBoxOther.Location = new System.Drawing.Point(4, 76);
			this.groupBoxOther.Name = "groupBoxOther";
			this.groupBoxOther.Size = new System.Drawing.Size(302, 130);
			this.groupBoxOther.TabIndex = 26;
			this.groupBoxOther.TabStop = false;
			this.groupBoxOther.Text = "Other Options";
			// 
			// groupBoxOutput
			// 
			this.groupBoxOutput.Controls.Add(this.comboBox1);
			this.groupBoxOutput.Controls.Add(this.comboBox2);
			this.groupBoxOutput.Controls.Add(this.comboBox3);
			this.groupBoxOutput.Controls.Add(this.comboBox4);
			this.groupBoxOutput.Controls.Add(this.comboBox7);
			this.groupBoxOutput.Controls.Add(this.comboBox5);
			this.groupBoxOutput.Location = new System.Drawing.Point(4, 12);
			this.groupBoxOutput.Name = "groupBoxOutput";
			this.groupBoxOutput.Size = new System.Drawing.Size(436, 58);
			this.groupBoxOutput.TabIndex = 27;
			this.groupBoxOutput.TabStop = false;
			this.groupBoxOutput.Text = "Select File Name Output";
			// 
			// comboBox9
			// 
			this.comboBox9.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboBox9.FormattingEnabled = true;
			this.comboBox9.Location = new System.Drawing.Point(93, 21);
